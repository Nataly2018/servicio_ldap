...
public class ConsultaConsultoriaConTotalesExcel {
    private Long idPoa;
    ...
    @ExcelYpfbAnnotation(posicionColumna = 31)
    ...
    @ExcelYpfbAnnotation(posicionColumna = 26)
    ...
    @ExcelYpfbAnnotation(posicionColumna = 28)
    ...
    @ExcelYpfbAnnotation(posicionColumna = 30)
    private BigDecimal presTotalGestiones;
    @ExcelYpfbAnnotation(posicionColumna = 33)
    private String consObjetivoConsultoria;
    @ExcelYpfbAnnotation(posicionColumna = 34)
    private String consActividadesConsultoria;
    @ExcelYpfbAnnotation(posicionColumna = 35)
    private String consPerfilConsultor;
    @ExcelYpfbAnnotation(posicionColumna = 36)
    private String consResultadosConsultoria;
    @ExcelYpfbAnnotation(posicionColumna = 32)
    ...
    public boolean equals(Object o) {
        ...
        ConsultaConsultoriaConTotalesExcel that = (ConsultaConsultoriaConTotalesExcel) o;
