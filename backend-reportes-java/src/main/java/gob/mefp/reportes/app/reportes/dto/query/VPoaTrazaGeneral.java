...
public class VPoaTrazaGeneral {
    ...
    private BigInteger presPrecioUnitario;
    private Integer presCantidadRequerida;
    private BigInteger presSalarioMensualConsultor;
    private BigInteger presTotalGestion;
    private Object presGastoGestionesFuturas;
    private BigInteger presTotalGastoGestionesFuturas;
    private BigInteger presTotalGestiones;
    ...
    private Object consAreasValidadorasConsultoria;
    ...
    private BigInteger operPonderacionOperacion;
    ...
    private BigInteger tarPonderacionPorcentualTarea;
    private String tarUnidadMedidaTarea;
    private String tarMedioVerificacion;
    private Boolean tarRequiereOtraArea;
    private BigInteger tarAvanceEsperado;
    private BigInteger tarLineaBase;
    private Object tarAreaResponsable;
    ...
    public BigInteger getPresPrecioUnitario() {
        return presPrecioUnitario;
    }

    public void setPresPrecioUnitario(BigInteger presPrecioUnitario) {
    ...
    public BigInteger getPresSalarioMensualConsultor() {
        return presSalarioMensualConsultor;
    }

    public void setPresSalarioMensualConsultor(BigInteger presSalarioMensualConsultor) {
        this.presSalarioMensualConsultor = presSalarioMensualConsultor;
    }

    @Basic
    @Column(name = "pres_total_gestion")
    public BigInteger getPresTotalGestion() {
        return presTotalGestion;
    }

    public void setPresTotalGestion(BigInteger presTotalGestion) {
        this.presTotalGestion = presTotalGestion;
    }

    @Basic
    @Column(name = "pres_gasto_gestiones_futuras")
    public Object getPresGastoGestionesFuturas() {
        return presGastoGestionesFuturas;
    }

    public void setPresGastoGestionesFuturas(Object presGastoGestionesFuturas) {
        this.presGastoGestionesFuturas = presGastoGestionesFuturas;
    }

    @Basic
    @Column(name = "pres_total_gasto_gestiones_futuras")
    public BigInteger getPresTotalGastoGestionesFuturas() {
        return presTotalGastoGestionesFuturas;
    }

    public void setPresTotalGastoGestionesFuturas(BigInteger presTotalGastoGestionesFuturas) {
        this.presTotalGastoGestionesFuturas = presTotalGastoGestionesFuturas;
    }

    @Basic
    @Column(name = "pres_total_gestiones")
    public BigInteger getPresTotalGestiones() {
        return presTotalGestiones;
    }

    public void setPresTotalGestiones(BigInteger presTotalGestiones) {
    ...
    public Object getConsAreasValidadorasConsultoria() {
        return consAreasValidadorasConsultoria;
    }

    public void setConsAreasValidadorasConsultoria(Object consAreasValidadorasConsultoria) {
    ...
    public BigInteger getOperPonderacionOperacion() {
        return operPonderacionOperacion;
    }

    public void setOperPonderacionOperacion(BigInteger operPonderacionOperacion) {
    ...
    public BigInteger getTarPonderacionPorcentualTarea() {
        return tarPonderacionPorcentualTarea;
    }

    public void setTarPonderacionPorcentualTarea(BigInteger tarPonderacionPorcentualTarea) {
    ...
    public BigInteger getTarAvanceEsperado() {
        return tarAvanceEsperado;
    }

    public void setTarAvanceEsperado(BigInteger tarAvanceEsperado) {
        this.tarAvanceEsperado = tarAvanceEsperado;
    }

    @Basic
    @Column(name = "tar_linea_base")
    public BigInteger getTarLineaBase() {
        return tarLineaBase;
    }

    public void setTarLineaBase(BigInteger tarLineaBase) {
        this.tarLineaBase = tarLineaBase;
    }

    @Basic
    @Column(name = "tar_area_responsable")
    public Object getTarAreaResponsable() {
        return tarAreaResponsable;
    }

    public void setTarAreaResponsable(Object tarAreaResponsable) {
